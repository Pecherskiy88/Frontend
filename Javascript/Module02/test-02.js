...
// Задание 10 g последовательность Хэеса, то есть пользователь вводит число и в результате должно быть выдано сообщение, с самой последовательностью, количеством шагов,
...
// Пример для удаления пользователя от Репеты!!!
// const users = ['Alex', 'Dima', 'Jora', 'Bob', 'Andrew'];

// console.log(users);

// const delUser = prompt('Введи имя для удаления');

// if(delUser !== null){
//     const hasName = users.includes(delUser);
//     if(hasName){
//         users.splice(hasName,1);
//         console.log(users);
//         alert(`Юзер ${delUser} удален`);
//     }else{
//         console.log('Такого имени нет, ошибка');
//     }
// }else{
...
// Деструктуризация Репета
// const a = [1,2,3,4];

// const [first,second,third,forth] = a;

// console.log(third);



// Звездочка. Перезаписать значение массивов друг в друга
// let a = 1;
// let b = 3;
...
//=============================
//ИНВАРЯНТНОЕ ВЫЧИСЛЕНИЕ

// const numbers = [12, 75, 90, 7, 23, 14];

// const length = numbers.length; // выводим длину масива в перемунную и за пределы цикла фор, что бы цикл каждый раз не перещитывал длину массива, при каждой итерации, а сразу сравнивал условие с уже известной длиной.
...
//Количество попыток введения пароля
